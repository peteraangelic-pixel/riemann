...
def tape_agent(steps: list, seat: int):
    ...
    def _agent(obs: dict, *a: Any, **k: Any) -> dict:
        ...
        # Kaggle replay row 0 is the initial observation; row 1 stores the
        # action emitted at environment step 0. Advance by one to avoid an
        # artificial opening PASS in every open-loop benchmark.
