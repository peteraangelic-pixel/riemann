"""Contract tests for the first current-TOP10 reactive profile."""
...
AGENT = ROOT / "agents/variants/agent_v10_reactive_subin.py"


def _load():
    spec = importlib.util.spec_from_file_location("_v10_reactive_subin", AGENT)
